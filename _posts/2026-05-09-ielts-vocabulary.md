...
| - [ ] | southern | adj. | 南方的 |
| - [ ] | southeast | n./adj. | 东南；东南方的 |
| - [ ] | southwest | n./adj. | 西南；西南方的 |
| - [ ] | northeast | n./adj. | 东北；东北方的 |
| - [ ] | northwest | n./adj. | 西北；西北方的 |
| - [ ] | eastern | adj. | 东方的；东部的 |
...
| - [ ] | variation | n. | 变种；变异 |
| - [ ] | diversity | n. | 多样性 |
| - [ ] | hybridisation | n. | =bybridization 杂交 |
| - [ ] | classify | v. | 分类 |
| - [ ] | reproduce | v. | 繁殖 |
| - [ ] | evolve | v. | 进化；发展 |
| - [ ] | fluctuate | v. | 波动；起伏 |
...
| - [ ] | stem | v./n. | 起源于；来自；茎；梗 |
| - [ ] | ancestor | n. | 祖宗；祖先 |
| - [ ] | descendant | n./v. | 后裔；后代；下降的 |
| - [ ] | offspring | n. | 后代；子孙；产物 |
| - [ ] | subgroup | n. | 子群 |
| - [ ] | feed | v. | 供养；喂养；进食 |
| - [ ] | breed | v./n. | 饲养；繁殖；品种 |
| - [ ] | interbreed | v. | （使）品种杂交 |
| - [ ] | hybridize | v. | =hybridise （使）杂交 |
...
| --- | --- | --- | --- |
| - [ ] | education | n. | 教育；培养 |
| - [ ] | primary | adj. | 初级的；主要的；小学教育的 |
| - [ ] | secondary | adj. | 中等的；次要的；中学教育的 |
| - [ ] | university | n. | 大学 |
| - [ ] | college | n. | 学院；大学 |
| - [ ] | institute | n. | 研究所 |
...
| - [ ] | riddle | n. | 谜；谜语 |
| - [ ] | obscure | adj. | 难以理解的 |
| - [ ] | instil | v. | =instill 逐渐灌输 |
| - [ ] | cram | v. | 把...塞进；（为应考）临时死记硬背 |
| - [ ] | emphasise | v. | =emphasize 强调；着重 |
| - [ ] | enhance | v. | 提高；增强 |
| - [ ] | enable | v. | 使能够 |
| - [ ] | inspire | v. | 鼓舞；给...灵感 |
| - [ ] | motive | n. | 动机；缘由 |
...
| - [ ] | platform | n. | 平台；讲台 |
| - [ ] | coed | adj./n. | =co-educational 男女同校的。（男女同校的大学生中的）女生 |
| - [ ] | register | v./n. | 登记；注册。登记表；注册簿 |
| - [ ] | roster | n. | 花名册；登记表；执勤表 |
| - [ ] | enrol | v. | =enroll 登记；注册；加入 |
| - [ ] | matriculation | n. | 注册入大学 |
| - [ ] | accommodation | n. | 住处；食宿招待 |
| - [ ] | dorm | n. | 宿舍 |
| - [ ] | dining hall | n. | 食堂 |
| - [ ] | canteen | n. | 水壶；[英]食堂 |
| - [ ] | laboratory | n. | =lab 实验室；研究室 |
| - [ ] | experiment | n. | 实验；试验 |
...
| - [ ] | pratical | adj. | 实际的；有用的；务实的；心灵手巧的 |
| - [ ] | doctrine | n. | 学说；教义；信条 |
...
| - [ ] | skim | v. | 掠过；擦过；略读 |
| - [ ] | scan | v./n. | 细看；浏览；扫描 |
| - [ ] | scrutinise | v. | =scrutinize 仔细检查 |
| - [ ] | recite | v. | 背诵；朗诵 |
| - [ ] | dictate | v. | 让（某人）听写；命令；强行规定 |
| - [ ] | examination | n. | =exam 考试；抽查 |
| - [ ] | test | v./n. | 测试；检验 |
| - [ ] | quiz | n. | 小测验 |
| - [ ] | presentation | n. | 陈述；表演；演出 |
| - [ ] | plagiarise | v. | =plagiarize 抄袭 |
| - [ ] | copy | n./v. | 复制品。抄写；复制 |
| - [ ] | print | v./n. | 打印。印刷品；照片 |
| - [ ] | thesis | n. | 论文 |
| - [ ] | essay | n. | 短文；小品文 |
...
| - [ ] | specialise | v. | =specialze 专攻 |
| - [ ] | absorb | v. | 理解；掌握 |
| - [ ] | concentrate | v. | （集中）心思；（使）浓缩 |
| - [ ] | focus | v./n. | 集中于；焦点 |
| - [ ] | utilise | v. | =utilize 利用 |
| - [ ] | usage | n. | 使用；用法 |
| - [ ] | tester | n. | 测试员；测试仪 |
| - [ ] | apply | v. | 应用；适用 |
...
| - [ ] | distil | v. | =distill 蒸馏；提取...的精华 |
| - [ ] | mode | n. | 模式；方式 |
| - [ ] | mould | v./n. | =mold 浇铸；塑造；模子 |
| - [ ] | prototype | n. | 原型；雏形 |
...
| --- | --- | --- | --- |
| - [ ] | culture | n. | 文化；文明；教养 |
| - [ ] | civilization | n. | =civilization 文明 |
...
| - [ ] | amuse | v. | 逗乐；给...提供娱乐 |
| - [ ] | gossip | n. | 闲聊；流言蜚语 |
| - [ ] | rumour | n. | =rumor 谣言；传闻 |
| - [ ] | consensus | n. | 共识；一致的意见 |
| - [ ] | festival | n. | 节日 |
| - [ ] | feast | n. | 盛宴；（宗教）节日 |
| - [ ] | programme | n./v. | =program 节目；方案；程序；为系统设置程序；计划 |
| - [ ] | rehearsal | n. | 排练 |
| - [ ] | perform | v. | 表演；演出 |
| - [ ] | imitate | v. | 模仿；效仿 |
| - [ ] | mimic | v. | 模仿；戏仿 |
...
| - [ ] | gallery | n. | 美术馆 |
| - [ ] | exhibition | n. | 展览；展览会 |
| - [ ] | aesthetic | adj. n. | =esthetic 审美的；审美观 |
| - [ ] | collect | v. | 收集；收藏 |
